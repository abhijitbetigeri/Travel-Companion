...
See [BLOG.md](BLOG.md) for the write-up, [ARCHITECTURE.md](ARCHITECTURE.md)
for how it's built, and [PITCH.md](PITCH.md) for the demo script.

**Third place — Battle of the Personal Brains**, September 2026.
